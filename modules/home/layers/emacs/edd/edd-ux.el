...
(use-package nano-theme
  ...
  (mode-line ((t (:background "#E5DFC5" :foreground "#37474F" :box (:line-width 3 :color "#E5DFC5")))))
  (org-block ((t (:background "#CEC8B1" :foreground "#37474F"))))
  (org-block-begin-line ((t (:foreground "#e5dfc5" :background "#42393C" :extend t :box (:line-width 3 :color "#42393C")))))
  (org-block-end-line ((t (:foreground "#e5dfc5" :background "#42393C" :extend t :box (:line-width 3 :color "#42393C")))))
  (term-color-yellow ((t :foreground "#b58900")))
  (ansi-color-yellow ((t :foreground "#b58900")))
  (term-color-orange ((t :foreground "#cb4b16")))
  (term-color-red ((t :foreground "#dc322f")))
  (ansi-color-red ((t :foreground "#dc322f")))
  (term-color-magenta ((t :foreground "#d33682")))
  (ansi-color-magenta ((t :foreground "#d33682")))
  (term-color-violet ((t :foreground "#6c71c4")))
  (term-color-blue ((t :foreground "#268bd2")))
  (ansi-color-blue ((t :foreground "#268bd2")))
  (term-color-cyan ((t :foreground "#2aa198")))
  (ansi-color-cyan ((t :foreground "#2aa198")))
  (term-color-green ((t :foreground "#859900")))
  (ansi-color-green ((t :foreground "#859900")))
  (term-color-bright-yellow ((t :background "#b58900")))
  (ansi-color-bright-yellow ((t :background "#b58900")))
  (term-color-bright-orange ((t :background "#cb4b16")))
  (term-color-bright-red ((t :background "#dc322f")))
  (ansi-color-bright-red ((t :background "#dc322f")))
  (term-color-bright-magenta ((t :background "#d33682")))
  (ansi-color-bright-magenta ((t :background "#d33682")))
  (term-color-bright-violet ((t :background "#6c71c4")))
  (term-color-bright-blue ((t :background "#268bd2")))
  (ansi-color-bright-blue ((t :background "#268bd2")))
